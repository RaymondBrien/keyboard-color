# Thank you to (https://img.shields.io/github/v/release/TomSchimansky/GuitarTuner) for the code
from typing import Optional
import copy
from pyaudio import PyAudio, paInt16 # TODO update requirements
...
def test():
    ...
    q = ProtectedList()
    a = AudioAnalyzer(q)  # call analyzer with thread
    a.start()

    # if duration is not None:  # TODO
    while True:
        q_data = q.get()
